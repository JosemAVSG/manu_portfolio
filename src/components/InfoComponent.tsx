...
const InfoComponent = () => {
  return (
    <div className={styles.infocomponent}>
      <div className="border-t-2 border-b-1 border-black row-span-1 ">
        <p className="m-4 sm:text-lg md:text-xl overflow-y-auto ">
      ...
      <div className="border-t-2 border-black row-span-1">
        <h2 className="m-4">correo</h2>
      </div>
      <div className="border-t-2  broder-gray-500 row-span-1">
